    ...
    <body>
        <div class="container">
          <a href="http://localhost:3000/" target="_blank" >
              ...
              </a> <div class="message">Contact Form Confirmation</div>
            <div class="body">
                ...
                <p>Email: ${email}</p>
                <p>Phone Number:${countrycode}  ${contact}</p>
                <p>Message: ${message}</p>
                <p>We appreciate your interest and will get back to you shortly. </p>
            </div>
            <div class="support">If you have any further questions or need immediate assistance, please feel free to reach
                out to us at <a href="mailto:learningways247platform@gmail.com">learningways247platform@gmail.com</a>. We are here to help!</div>
        </div>
    </body>
